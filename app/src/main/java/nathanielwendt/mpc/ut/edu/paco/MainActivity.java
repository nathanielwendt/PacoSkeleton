...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filter.insert(new STPoint(loc.getLongi, loc.getLat, system.getcurrentMillis));

        Location location = ocaitonServices.getLocation()

        filter.windowPoK(new STRegion(new S))
